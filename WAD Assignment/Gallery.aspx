            ...
            <asp:ListView ID="ListView1" runat="server" DataKeyNames="ArtId" DataSourceID="SqlDataSource1" GroupItemCount="4">
                <AlternatingItemTemplate>
                    <td runat="server" style="background-color: #FAFAD2;color: #284775;">
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='Server.MapPath(<%# Eval("ArtUrl") %>)' Height="200px" Width="300px" CommandName="ArtUrl"/>
                        <br />
                    </td>
                </AlternatingItemTemplate>
                <EditItemTemplate>
...
<td runat="server" />
                ...
                <ItemTemplate>
                    <td runat="server" style="background-color: #FFFBD6;color: #333333;">
                        <asp:ImageButton ID="ImageButton1" runat="server" ImageUrl='Server.MapPath(<%# Eval("ArtUrl") %>)' Height="200px" Width="300px" CommandName="ArtUrl" ImageAlign="NotSet" />
                        <br />
                    </td>
                </ItemTemplate>
                <LayoutTemplate>
